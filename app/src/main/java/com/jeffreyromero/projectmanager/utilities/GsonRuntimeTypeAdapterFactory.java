 ...
 * Create a {@code GsonRuntimeTypeAdapterFactory} by passing the base type and type field
 * name to the {@link #of} factory method. If you don't supply an explicit type
 * field name, {@code "type"} will be used. <pre>   {@code
 *   GsonRuntimeTypeAdapterFactory<Shape> shapeAdapterFactory
 *       = GsonRuntimeTypeAdapterFactory.of(Shape.class, "type");
 * }</pre>
 ...
 *   GsonRuntimeTypeAdapterFactory<Shape> shapeAdapterFactory = GsonRuntimeTypeAdapterFactory.of(Shape.class)
